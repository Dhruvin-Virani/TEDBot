...
# print(QuestionsAnswer("An airplane accelerates down a runway at 3.20 m/s^2 for 32.8 s until is finally lifts off the ground. Determine the distance traveled before takeoff."))
